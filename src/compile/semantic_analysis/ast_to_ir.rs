...
impl ProgramAST {
    ...
    pub fn to_ir(self) -> AstToIrResult<ProgramIr> {
        ...
        let program_ir = self
            .stmt_list
            .into_iter()
            .fold(Ok(ProgramIr::empty()), |acc, stmt| {
...
impl LambdaAST {
    fn to_ir(
        ...
        *lambda_count += 1;
        ...
        program_ir.func_list.push(FuncIr {
            params_len,
            body,
            pos: self.pos,
